...
test_that("ARMA search works for In-Sample", {
  ...
  res = search.varma(Z, maxParams = c(2,2,2,0,0,0),
                    ...
                    measureOptions = get.measure.options(c("aic"),c()))
...
test_that("ARMA search works for In-Sample with exogenous", {
  ...
  res = search.varma(Z, Exo, maxParams = c(2,2,2,0,0,0), xGroups = list(c(2L),c(2L,3L)),
                    searchOptions = get.search.options(printMsg = printMsg),
                    measureOptions = get.measure.options(c("aic"),c()),
                    modelCheckItems = get.modelcheck.items(prediction = FALSE))
...
test_that("VARMA search works for In-Sample with exogenous", {
  ...
  res = search.varma(Endo, Exo, numTargets = 3, ySizes = c(1L,2L),
                    ...
                    searchOptions = get.search.options(printMsg = printMsg),
                    measureOptions = get.measure.options(c("aic", "sic"),c()),
                    searchItems = get.search.items(all = TRUE),
                    modelCheckItems = get.modelcheck.items(prediction = FALSE))
...
test_that("VARMA search works when changing Indexes NO exogenous", {
  ...
  res0 = search.varma(Endo, NULL, 2, ySizes = c(1L,2L),
                     maxParams = c(2,2,2,0,0,0),  searchOptions = get.search.options(printMsg = printMsg),
                     measureOptions = get.measure.options(c("aic", "sic"),c()),
                     searchItems = get.search.items(all = TRUE))
...
test_that("VARMA search works when changing Indexes WITH exogenous", {
  ...
  Exo=x[,4:5]
  res = search.varma(Endo, NULL, 2, ySizes = c(1L,2L),
                    maxParams = c(0,2,3,0,0,0),  searchOptions = get.search.options(printMsg = printMsg),
                    measureOptions = get.measure.options(c("aic", "sic"),c()),
                    searchItems = get.search.items(all = TRUE))
  allWeights = sort(sapply(res$aic$target1$model$all, function(x){x$weight}))
...
test_that("V-ARMA search works for Out-Sample", {
  ...
  res = search.varma(Endo, Exo, 2,
                    ...
                    searchOptions = get.search.options(printMsg = printMsg),
                    measureOptions = get.measure.options(c(), c("crps", "mae", "direction"),
                                                       horizons = c(1L,2L), simFixSize = 2),
                    searchItems = get.search.items(all = TRUE), newX = newX,
                    modelCheckItems = get.modelcheck.items(estimation = TRUE, prediction = TRUE,
...
test_that("VARMA search works when parallel", {
  ...
  res = search.varma(x[,1:3], NULL, 2,
                    ...
                    measureOptions = get.measure.options(c("aic"), c("crps", "mae", "direction"),
                                                       horizons = c(1L,2L), simFixSize = 2),
                    searchItems = get.search.items(all = TRUE),
                    modelCheckItems = get.modelcheck.items(estimation = FALSE, prediction = FALSE),
...
test_that("VARMA search works with inclusion weights", {
  ...
  res = search.varma(Endo, Exo, 2,
                    ...
                    measureOptions = get.measure.options(c(), c("crps", "mae", "direction"),
                                                       horizons = c(1L,2L), simFixSize = 2),
                    searchItems = get.search.items(all = TRUE, inclusion = TRUE),
                    modelCheckItems = get.modelcheck.items(estimation = FALSE, prediction = FALSE))
...
test_that("VARMA search works with predictions (bests)", {
  ...
  res = search.varma(Endo, Exo, 2, maxHorizon = 3, newX = newX,
                    ...
                    simUsePreviousEstim = FALSE,
                    searchOptions = get.search.options(printMsg = printMsg),
                    measureOptions = get.measure.options(c("aic"), c("crps", "mae"),
                                                       horizons = c(1L,2L), simFixSize = 2),
                    searchItems = get.search.items(all = TRUE, type1 = TRUE),
                    modelCheckItems = get.modelcheck.items(estimation = FALSE, prediction = FALSE, predictionBoundMultiplier = 0))
...
test_that("VARMA search works with predictions (cdfs)", {
  ...
  res = search.varma(Endo, Exo, 2, maxHorizon = 3, newX = newX,
                    ...
                    measureOptions = get.measure.options(c("aic"), c("crps", "mae"),
                                                       horizons = c(1L,2L), simFixSize = 2),
                    searchItems = get.search.items(all = TRUE, type1 = TRUE, cdfs = c(0,1,0)),
                    modelCheckItems = get.modelcheck.items(estimation = FALSE, prediction = FALSE, predictionBoundMultiplier = 0))
  h=2
  v = 1
  sum = 0
...
test_that("VARMA search works with predictions (extreme bounds)", {
  ...
  res = search.varma(Endo, Exo, 2, maxHorizon = 3, newX = newX,
                    ...
                    measureOptions = get.measure.options(c("aic"), c("crps", "mae"),
                                                       horizons = c(1L,2L), simFixSize = 2),
                    searchItems = get.search.items(all = TRUE, type1 = TRUE, cdfs = c(0,1,0), extremeMultiplier = 2),
                    modelCheckItems = get.modelcheck.items(estimation = FALSE, prediction = FALSE, predictionBoundMultiplier = 0))
  mn = Inf
  mx = -Inf
  v = 1
...
test_that("VARMA summary works", {
  ...
  res = search.varma(Endo, Exo, 2, newX = newX,
                    ...
                    simUsePreviousEstim = FALSE,
                    searchOptions = get.search.options(printMsg = printMsg),
                    measureOptions = get.measure.options(c("aic", "sic"), c("crps", "rmse", "direction"),
                                                       horizons = c(1L,2L), simFixSize = 2),
                    searchItems = get.search.items(all = TRUE, type1 = TRUE),
                    modelCheckItems = get.modelcheck.items(estimation = FALSE, prediction = FALSE, predictionBoundMultiplier = 0))
...
test_that("estim.sur SplitSearch works (no subsetting)", {
  ...
  modelCheckItems = get.modelcheck.items(prediction = FALSE, predictionBoundMultiplier = 0)

  split = search.varma_s(y = Endo, x = Exo, ySizes = list(c(1L,2L), c(3L)), counts = c(NA, NA),
