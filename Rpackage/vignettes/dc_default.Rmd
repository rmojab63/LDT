...
There are `r ncol(x) ` potential predictors and the size of the potential predicting models is relatively large. We follow a step-wise search approach by defining the following two arguments for the `search.dc_s()` function:
...
berka_res <- list(
  logit = search.dc_s(
    ...
    searchItems = get.search.items(bestK = 20, inclusion = TRUE),
