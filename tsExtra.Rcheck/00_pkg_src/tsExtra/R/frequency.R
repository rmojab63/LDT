...
#' \itemize{
#' \item **Value String:** \code{"#"} (the number is the \code{position})
...
#' you need the following information:
#' \itemize{
#' \item **Value String:** \code{"#"} (the number is the \code{year})
...
#' you need the following information:
#' \itemize{
#' \item **Value String:** \code{"#q#"} (first '#' is the \code{year}, second '#' is the
...
#' \item **class:** Determines the class of this frequency.
#' \item **year:** Determines the \code{year}.
#' \item **quarter:** Determines the \code{quareter}.
#' }
#'
#' @export
#'
...
#'
#' q_invalid <- F_Quarterly(2020, 0)
#' q_invalid <- F_Quarterly(2020, 5)
#' q_invalid <- as.ldtf("2021q0", "q")
#' q_invalid <- as.ldtf("2021q5", "q")
#' q_invalid <- as.ldtf("2021", "q")
#' }
#'
...
#' # Don't make the following mistakes:
#'
#' m_invalid <- F_Monthly(2020, 0)
#' m_invalid <- F_Monthly(2020, 5)
#' m_invalid <- as.ldtf("2021m0", "m")
#' m_invalid <- as.ldtf("2021m13", "m")
#' m_invalid <- as.ldtf("2021", "m")
#' }
...
#' you need the following information:
#' \itemize{
#' \item **Value String:** \code{"#"} (the number is the \code{year}, which means the string representation is the first year of the interval)
#' \item **Class String:** \code{"z#"} ('#' represents the value: \code{z}; e.g., z3 means every 3 years)
#' }
#'
#' @return An object of class 'ldtf'. It is also a list with the following members:
#' \itemize{
...
#' # Don't make the following mistakes:
#'
#' my_invalid <- F_MultiYearly(2020, 0)
#' my_invalid <- F_MultiYearly(2020, -5)
#' my_invalid <- as.ldtf("2021", "z")
#' }
...
#' you need the following information:
#' \itemize{
#' \item **Value String:** \code{"#:#"} (first # is the \code{year} and
#' the second # is the \code{position}; e.g., 2010:8/12 or 2010:10/10. Note that 2000:0/2 or 2000:13/12 are invalid.
#' \item **Class String:** \code{"y#"} (the number is the value: \code{x})
#' }
#'
#' @return An object of class 'ldtf'. It is also a list with the following members:
#' \itemize{
...
#' you need the following information:
#' \itemize{
#' \item **Value String:** \code{"#:#"} (Similar to \code{X-Times-A-Year}. Note that the string representation refers to the first year of the interval.)
#' \item **Class String:** \code{"x#z#"} (first '#' is the value: \code{x},
...
#' # Don't make the following mistakes:
#'
#' xtzy_invalid <- F_XTimesZYears(2020, 3, 5, 0)
#' xtzy_invalid <- F_XTimesZYears(2020, 3, 0, 1)
#' xtzy_invalid <- as.ldtf("2021:25", "x24y2")
#' }
F_XTimesZYears <- function(year, x, z, position){
  ...
  res <- .F_XTimesZYears(year, x, z, position)
  res
}
...
#' you need the following information:
#' \itemize{
#' \item **Value String:** First day of the week in \code{"YYYYMMDD"} format.
...
#'
#' w_invalid <- as.ldtf("1399109", "w") # this is a too old date and unsupported
#' w_invalid <- as.ldtf("20230132", "w") # invalid day in month
#' w_invalid <- as.ldtf("20231331", "w") # invalid month
#'
#' }
...
#' you need the following information:
#' \itemize{
#' \item **Value String:** First day of the first week in \code{"YYYYMMDD"} format.
#' \item **Class String:** \code{"w#"} (the number is value: \code{k}; e.g., w3 means every 3 weeks)
#' }
#'
#' @return An object of class 'ldtf'. It is also a list with the following members:
#' \itemize{
...
#' # Don't use invalid or unsupported dates.
#'
#' mw_invalid <- as.ldtf("1399109", "w4") # this is a too old date and unsupported
#' mw_invalid <- as.ldtf("20230132", "w5") # invalid day in month
#' mw_invalid <- as.ldtf("20231331", "w2") # invalid month
#' mw_invalid <- as.ldtf("20231012", "w0")
#' }
...
#' # Don't use invalid or unsupported dates.
#'
#' d_invalid <- as.ldtf("1399109", "d") # this is a too old date and unsupported
#' d_invalid <- as.ldtf("20230132", "d") # invalid day in month
#' d_invalid <- as.ldtf("20231331", "d") # invalid month
#'
#' }
...
#' you need the following information:
#' \itemize{
#' \item **Value String:** First day of the interval in \code{"YYYYMMDD"} format.
#' \item **Class String:** \code{"d#"} (the number is value: \code{k}; e.g., d3 means every 3 days)
#' }
#'
#' @return An object of class 'ldtf'. It is also a list with the following members:
#' \itemize{
...
#' # Don't use invalid or unsupported dates.
#'
#' md_invalid <- as.ldtf("1399109", "d3") # this is a too old date and unsupported
#' md_invalid <- as.ldtf("20230132", "d4") # invalid day in month
#' md_invalid <- as.ldtf("20231331", "d5") # invalid month
#'
#' }
...
#' you need the following information:
#' \itemize{
#' \item **Value String:** \code{"YYYYMMDD"} (First day of the interval in \code{"YYYYMMDD"} format.)
#' \item **Class String:** \code{"i:...-..."} (the first '...' is \code{weekStart} and the second '...' is \code{weekEnd}; e.g., \code{i:mon-fri} means a week from Monday to Friday)
#' }
#'
#' @return An object of class 'ldtf'. It is also a list with the following members:
#' \itemize{
...
#' # Don't use invalid or unsupported dates.
#'
#' dw_invalid <- as.ldtf("1399109", "d3") # this is a too old date and unsupported
#' dw_invalid <- as.ldtf("20230132", "d4") # invalid day in month
#' dw_invalid <- as.ldtf("20231331", "d5") # invalid month
#'
#' # don't use invalid week definitions:
#' F_DailyInWeek(2023, 5, 16, "Wednesday", "sat")
#'
#' }
F_DailyInWeek <- function(year, month, day, weekStart = "mon",
...
#' \item **Class String:** \code{Ls} or \code{Ls:...} (in which ... is the semi-colon separated \code{items})
#' }
#'
#' @return An object of class 'ldtf'. It is also a list with the following members:
#' \itemize{
...
#' # Don't make the following mistakes:
#'
#' L_invalid <- as.ldtf("E", "Ls:A;B;C;D") # 'E' is not a member of the list
#' L_invalid <- F_ListString(c("A","B","C","D"), "E")
#'
#' }
...
#' \item **Class String:** \code{Ld} or \code{Ld:...} (in which '...' is the semi-colon separated \code{items})
#' }
#'
#' @return An object of class 'ldtf'. It is also a list with the following members:
#' \itemize{
...
#' Ld_invalid <- F_ListDate(c("20231101","20220903","20200823","20230303"), "20231102")
#'
#' }
...
#' you need the following information:
#' \itemize{
#' \item **Value String:** \code{"YYYYMMDD:#"} (the number is the value: \code{hour})
...
#' # Don't make the following mistakes:
#'
#' ho_invalid <- as.ldtf("20231101:3", "ho|j:wed-sat") # invalid format in day-based frequency
#' ho_invalid <- F_Hourly(F_Daily(2023,5,16),25) # invalid hour
#'
#' }
...
#' you need the following information:
#' \itemize{
#' \item **Value String:** \code{"YYYYMMDD:#"} (the number is the value: \code{minute})
...
#' # Don't make the following mistakes:
#'
#' mi_invalid <- as.ldtf("20231101:3", "mi|j:wed-sat") # invalid format in day-based frequency
#' mi_invalid <- F_Minutely(F_Daily(2023,5,16),2000) # invalid minute
#'
#' }
...
#' you need the following information:
#' \itemize{
#' \item **Value String:** \code{"YYYYMMDD:#"} (the number is the value: \code{second})
...
#' # Don't make the following mistakes:
#'
#' mi_invalid <- as.ldtf("20231101:3", "se|j:wed-sat") # invalid format in day-based frequency
#' mi_invalid <- F_Secondly(F_Daily(2023,5,16),100000) # invalid second
#'
#' }
...
#' you need the following information:
#' \itemize{
#' \item **Value String:** \code{"#"} (in which '#' is the value: \code{position})
#' \item **Class String:** \code{"da#|..."} (in which '#' is the value: \code{x} and '...' is the 'Class String' of \code{day}))
#' }
#'
#' @return An object of class 'ldtf'. It is also a list with the following members:
#' \itemize{
...
#' # Don't make the following mistakes:
#'
#' xd_invalid <- as.ldtf("20231101:3", "da|i:wed-sat") # invalid format in day-based frequency
#' xd_invalid <- F_XTimesADay(F_Daily(2023,5,16),4,0) # invalid position
#'
#' }
