...
public:
  ...
  /// @param hasMissing on exit, it determines if the variable contains missing
  /// observations
  /// @return a tuple in which the first value is the start and the second value
  /// is the end (it might be invalid: start>end). Its length will be
  /// 'end-start+1'
