...
#' \tabular{ll}{
#'    \code{nRows} \tab The number of rows in the matrix.\cr
#'   \code{nCols} \tab The number of columns in the matrix.\cr
#'    \code{colFirst} \tab Whether to remove columns or rows first.\cr
#'    \code{colRemove} \tab The indices of the columns to be removed.\cr
#'    \code{rowRemove} \tab The indices of the rows to be removed.
#'   }
#' @export
#'
#' @examples
